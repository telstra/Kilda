...
public class DeallocateResourcesResponse extends DbResponse {
    @Singular
    ...
    @Builder
    public DeallocateResourcesResponse(@NonNull MessageContext messageContext, @NonNull UUID commandId,
                                       @Singular Collection<FlowResources> oldResources,
                                       @Singular Collection<FlowResources> rejectedResources) {
