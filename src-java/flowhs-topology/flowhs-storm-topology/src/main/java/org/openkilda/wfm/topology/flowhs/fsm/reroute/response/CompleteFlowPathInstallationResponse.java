...
public class CompleteFlowPathInstallationResponse extends DbResponse {
    ...
    @Builder
    public CompleteFlowPathInstallationResponse(
            @NonNull MessageContext messageContext, @NonNull UUID commandId, PathId newPrimaryForwardPath,
