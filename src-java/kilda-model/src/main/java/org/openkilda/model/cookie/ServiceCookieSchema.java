...
public class ServiceCookieSchema extends CookieSchema {
    ...
    public Cookie makeBlank() {
        return makeBlank(CookieType.SERVICE_OR_FLOW_SEGMENT);
    }

    public Cookie makeBlank(CookieType type) {
        return makeBlank(type, 0);
    }

    public Cookie makeBlank(CookieType type, long tag) {
        ...
        payload = setField(payload, UNIQUE_ID, tag);
    ...
    public enum ServiceCookieTag implements CookieEnumField {
